/**************************************************************************
 * ZoneTestProviderBase.java, tracscan Android
 *
 * Copyright 2013
 * Description : 
 * Author(s)   : Harmony
...
public abstract class ZoneTestProviderBase extends TestDBBase {
	...
	public void testRead() {
		...
		if (this.entity != null) {
			try {
				Cursor c = this.provider.query(Uri.parse(ZoneProviderAdapter.ZONE_URI + "/" + this.entity.getId()), this.adapter.getCols(), null, null, null);
				c.moveToFirst();
	...
	public void testDelete() {
		...
		if (this.entity != null) {
			try {
				result = this.provider.delete(Uri.parse(ZoneProviderAdapter.ZONE_URI + "/" + this.entity.getId()), null, null);
