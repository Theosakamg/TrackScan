/**************************************************************************
 * DateUtils.java, tracscan Android
 *
 * Copyright 2013
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.tactfactory.tracscan.harmony.util;
...
public class DateUtils extends android.text.format.DateUtils {
	...
	public static String formatDateToString(DateTime date, boolean local) {
		java.text.DateFormat df = TracscanApplication.getDateFormat();
	...
	public static String formatTimeToString(DateTime time) {
		String result = null;
		if (TracscanApplication.is24Hour()) {
	...
	public static DateTime formatStringToDate(String date) {
		return formatStringToDateTime(TracscanApplication
							.getDateFormat(), date);
	}
