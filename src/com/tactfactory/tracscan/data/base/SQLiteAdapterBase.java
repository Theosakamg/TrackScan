/**************************************************************************
 * SQLiteAdapterBase.java, tracscan Android
 *
 * Copyright 2013
 * Description : 
 * Author(s)   : Harmony
...
public abstract class SQLiteAdapterBase<T> {
	...
	public static final String TAG = "TracscanSQLiteAdapterBase";
	 ...
	 * Open Helper.
	 */
	protected TracscanSQLiteOpenHelper mBaseHelper;
	...
	protected SQLiteAdapterBase(final Context ctx) {
		this.ctx = ctx;
		this.mBaseHelper = new TracscanSQLiteOpenHelper(
				ctx,
				DB_NAME,
				null,
				TracscanApplication.getVersionCode(ctx));
